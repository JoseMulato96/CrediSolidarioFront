import {
  Component, EventEmitter, forwardRef, Input, Output, ViewEncapsulation
} from '@angular/core';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';
import { SelectItem } from 'primeng/api/selectitem';

@Component({
  selector: 'app-mim-select',
  templateUrl: './mim-select.component.html',
  styleUrls: ['./mim-select.component.css'],
  encapsulation: ViewEncapsulation.None,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => MimSelectComponent),
      multi: true
    }
  ]
})
export class MimSelectComponent implements ControlValueAccessor {
  /**

...
export const environment: environmentClass = {
  ...
  ceropapel: "/pruebas-SimuladorCrediSolidario/", //Para ambiente de pruebas LFP
  // ceropapel: "/CeroPapelWeb/", //Para ambiente de produción LFP
  redirect: "https://redcooperamoscoomeva.com.co/iniciar-sesion/",

  backend: "http://" + document.location.hostname + ":8080/", //Para ambiente local tener en cuenta el puerto LFP
  // backend: "http://eap7-gsisin.pruebas.intracoomeva.com.co/pruebas-SimuladorCrediSolidario/", //Para ambiente de pruebas LFP
  // backend: "https://secure.coomeva.com.co/SimuladorCrediSolidario/", //Para ambiente de produción LFP
